# MASTER CONTEXT — Pub Imóveis

**Identificador Canônico:** `pub-imoveis`  
...
Plataforma inteligente de transações imobiliárias e tokenização de ativos.
...
- **Repositório GitHub:** `pubcoreagencia/pub-imoveis`
